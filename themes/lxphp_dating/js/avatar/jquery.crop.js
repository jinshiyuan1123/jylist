	...
	$.fn.crop = function(options){
		...
		image.onload = function(){
			...
			if(first){
				...
				$('#select_btn_new').click(function(){
					$.post('index.php?s=/Home/User/qxAvatar',{uploadfiles:o.res},function(){
						history.go(-1);
					})
				});
